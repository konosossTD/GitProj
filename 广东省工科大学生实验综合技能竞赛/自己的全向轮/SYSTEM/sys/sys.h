...
extern float Position_A,Position_B,Position_C,Rate_A,Rate_B,Rate_C; //PID控制相关变量
extern long int Target_A,Target_B,Target_C;     //电机目标值
...
extern int RC_Velocity,Max_Velocity,RC_Position;
